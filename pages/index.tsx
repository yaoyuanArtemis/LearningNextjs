...
export default function Home() {
  return (
    <>
      ...
      <p>
        I graduated from Computer Talent Class,Department of Computer Science,
        Anhui University (安徽大学计算机英才班) with a bachelor’s degree advised
        by Zhang Lei (张磊).
      </p>
      ...
      <ul>
        ...
        <li>2014.9 - 2017.6,Qingyang No.1 Middle School,Qingyang,China🇨🇳.</li>
      </ul>
      <h3 id="-workexperience">💻 WorkExperience</h3>
      <ul>
        <li>
          2021.7 - 2023.9,Infrastructure Research and Develpment Center at China
          Merchants Bank(CMB).
        </li>
      ...
      <ul>
        <li>
          ...
          Algorithm for Large-Scale Overlapping Community Detection 2021 IEEE
          Congress on Evolutionary Computation (CEC) DOI:
